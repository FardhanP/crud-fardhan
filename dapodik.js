...
app.get('/dataSiswa/add', isAuthenticated, (req, res) => {
    res.render('addData', {
...
//! Proses delete siswa
app.delete('/dataSiswa/:nisn', isAuthenticated, (req, res) => {
...
app.get('/dataSiswa/detail/edit/:nisn', isAuthenticated, async (req, res) => {
...
app.put('/dataSiswa', isAuthenticated, 
    [
...
app.get('/dataSiswa/detail/:nisn', isAuthenticated, async (req, res) => {
    const siswa = await Siswa.findOne({ nisn: req.params.nisn });
    res.render('detail', {
